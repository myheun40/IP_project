    ...
    <div class="nav-actions">
        ...
        <div class="action-buttons">
            <c:if test="${reviewDto.member.username eq pageContext.request.userPrincipal.name}">
                <button onclick="location.href='/review_board/edit/${reviewDto.reviewIdx}'"
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-actions">
            ...
            <button onclick="location.href='${pageContext.request.contextPath}/review_board/remove/${reviewDto.reviewIdx}'"
                    class="modal-button">
                삭제
            </button>
        </div>
